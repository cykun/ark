...
public class ZKConsistentHashLoadBalancer implements ServiceLoadBalancer<ServiceInstance<ServiceMeta>> {
    ...
    public ServiceInstance<ServiceMeta> select(List<ServiceInstance<ServiceMeta>> serviceInstances, int hashCode) {
        TreeMap<Integer, ServiceInstance<ServiceMeta>> ring = makeConsistentHashRing(serviceInstances);
    ...
    private static TreeMap<Integer, ServiceInstance<ServiceMeta>> makeConsistentHashRing(List<ServiceInstance<ServiceMeta>> servers) {
    ...
    private static String buildServiceInstanceKey(ServiceInstance<ServiceMeta> instance) {
